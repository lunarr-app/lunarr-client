export const CONTINUE_AGE_PRESETS = [0, 7, 30, 90] as const;

export type ContinueAgePreset = (typeof CONTINUE_AGE_PRESETS)[number] | "custom";

export function isContinueAgePreset(days: number): days is (typeof CONTINUE_AGE_PRESETS)[number] {
...
export function formatContinueAgePresetLabel(days: (typeof CONTINUE_AGE_PRESETS)[number]) {
